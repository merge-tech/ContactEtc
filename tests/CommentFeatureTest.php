...
class CommentFeatureTest extends \Tests\TestCase
{
    ...
    {
//
//        Config::set('contactetc.contact_form_pages.'. ContactEtcServiceProvider::DEFAULT_FORM_PAGE_ID, [
//
//                'send_to' => "test@example.com",
//                'fields' =>
//                    function () {
//                        return [
//                            new \WebDevEtc\ContactEtc\FieldTypes\Email('testemail'),
//                            new \WebDevEtc\ContactEtc\FieldTypes\Text('testname'),
//                            new \WebDevEtc\ContactEtc\FieldTypes\Textarea('testmessage'),
//                        ];
//                    }]
//        );
